...
How to run Marvel Rivals Guide locally inside containers via Laravel
Sail on **Bazzite** (or any Fedora-based atomic distro: Silverblue,
...
DB_HOST=mysql
DB_PORT=3306
DB_DATABASE=marvel_rivals_guide
DB_USERNAME=sail
